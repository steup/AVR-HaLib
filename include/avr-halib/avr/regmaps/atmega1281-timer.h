 ...
 *	\brief		Register map for Timer0 of atmega1281
 *	\ingroup	atmega128
 */
class Timer0
{
...
/**
 * TODO check this  (copy from at90can128)
 *	\brief		Register map for Timer2 of atmega1281
 *	\ingroup	atmega1281
 *
 */
class Timer2
...
/**
 *	\brief		Register map for Timer1,3 and 4 of atmega1281
 *	\ingroup	atmega1281
 *
...
/**
 *	\brief		Register map for Timer1 of atmega1281
 *	\ingroup	atmega1281
 *
 *	\todo		Add input capture support
 */
struct Timer1Desc
{
// 	typedef interrupts::atmega1281::Timer1IntMap IntMap;
	enum Addresses
	{
		tifr=0x36,
		timsk=0x6F,
