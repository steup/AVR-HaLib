...
#include <avr-halib/drivers/avr/twi.h>
        ...
        struct configure
        {
            struct type
            {
                private:
                    ...
                    struct TWIConfig : public drivers::avr::TWIMaster::DefaultConfig
                    {
                        typedef typename Config::RegMap RegMap;
                    };
                    typedef typename drivers::avr::TWIMaster::configure< TWIConfig >::type BaseTWI;
                    typedef typename common::Singleton< BaseTWI >::type Base;
                public:
