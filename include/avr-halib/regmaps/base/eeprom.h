...
#include <avr-halib/drivers/avr/eeprom.h>
...
namespace base
{
    ...
    struct EEPROM
    {
        typedef drivers::avr::EEPROM::DefaultConfig DefaultConfig;
        ...
        struct configure
        {
            struct type
            {
                typedef typename drivers::avr::EEPROM::configure<Config>::type Driver;
